    ...
    <main className='main-container'>
      ...
      <Sidebar/>
        ...
        <div className='gg'>
            ...
            <div className='card'>
                <div className='card-inner'>
                    <h3 className='tit'>Expression des besoins non valider</h3>
            ...
            <div className='card'>
                <div className='card-inner'>
                    <h3 className='tit'>Expression des besoins valider</h3>
...
export default DashboardAllDMM
