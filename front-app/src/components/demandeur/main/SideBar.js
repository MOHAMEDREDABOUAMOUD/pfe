        ...
        <div className="menu_container">
          <div className="menu_items">
            <ul className="menu_item">
              ...
              <li className="item">
                <Link to="#" className="link flex">
                  <i className="bx bx-dashboard-alt"><Icon icon="fluent-mdl2:b-i-dashboard" /></i>
                  <span onClick={() => handleSidebarItemClick('dashboard')}>Dashboard</span>
                </Link>
              </li>
              <li className="item">
                <Link to="#" className="link flex">
            ...
            <ul className="menu_item">
              ...
              <li className="item">
                <Link to="#" className="link flex">
                  <i className="bx bx-dashboard"><Icon icon="iconamoon:settings-bold" /></i>
                  <span onClick={() => handleSidebarItemClick('settings')}>Settings</span>
                </Link>
              </li>
